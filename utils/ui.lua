...
do
    ...
    function I(v)
        ...
        local function a0(a1)
            ...
            local E =
                game:GetService("TweenService"):Create(W, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {Position = a3})
            E:Play()
            wait(1)
        end
        W.InputBegan:Connect(
            function(a1)
                if
                    a1.UserInputType == Enum.UserInputType.MouseButton1 or
                        a1.UserInputType == Enum.UserInputType.Touch and not library.drag
                 then
                    X = true
                    Z = a1.Position
                    _ = W.Position
        ...
        W.InputChanged:Connect(
            function(a1)
                if
                    a1.UserInputType == Enum.UserInputType.MouseMovement or
                        a1.UserInputType == Enum.UserInputType.Touch and not library.drag
                 then
                    Y = a1
                end
    ...
    function E(v, a4, a5, a6, a7, a8)
        local a9 = typeof(a8) == "function" and a8 or function()
            end
...
local aw = av()
local library = {Name = "1halla hub", SaveConfig = {SeperatePlayer = true, MainPathName = "OneHalla_Hub"}, flags = {}}
local ay = {}
local az = {}
local aA
local aB
...
function library:LoadingScreen()
    ...
    J(
        ...
        function()
            ...
            bj()
            library:Init()
            library:SendNotification({Title = "คำเตือน", Type = "warning", Text = "เข้าดิสคอร์ดเพื่อรับสคริปเพิ่มเติม"})
        end
    )
    J(
        bA,
        function()
            ...
            library:SendNotification({Title = "Discord", Type = "Info", Text = "คัดลอกลิ้งค์ Discord เรียบร้อย"})
        end
    )
end
...
function library:NewWindow(bJ)
    bx = F "ScreenGui" {Name = j, ZIndexBehavior = Enum.ZIndexBehavior.Sibling, Parent = game.CoreGui, Enabled = false}
    aW =
        F "Frame" {
        Name = "Background",
        BackgroundColor3 = Color3.fromRGB(30, 30, 30),
    ...
    local bK =
        F "ScreenGui" {Name = j, ZIndexBehavior = Enum.ZIndexBehavior.Sibling, Parent = game.CoreGui, Enabled = false}
    local bL =
        F "ImageLabel" {
        Name = "Background",
        ...
        local cj =
            ...
            [k] = {
                ...
                F "ImageButton" {
                    ...
                    Position = UDim2.fromScale(1, 0.5),
                    Size = UDim2.fromOffset(20, 20),
                    [k] = {F "UIGradient" {Color = o.Gradient and s or r, [l] = function(ak)
                                AddtoThemeGradient(ak)
                            end}, F "UICorner" {Name = "UICorner", CornerRadius = UDim.new(0, 3)}}
                }
            }
        }
        local ck =
        ...
        for x, y in pairs(ch) do
            local cm =
                ...
                [k] = {
                    ...
                    F "UIGradient" {Color = o.Gradient and s or r, [l] = function(ak)
                            AddtoThemeGradient(ak)
                        end}
                }
            }
        ...
        function cE:NewSection(cH)
            ...
            local cK =
                ...
                [k] = {
                    ...
                    F "UIStroke" {Name = "UIStroke", Transparency = 0.4, Color = o.MainColor, [l] = function(ak)
            ...
            function cN:Toggle(cS)
                ...
                local cV = cS["Callback"] or function()
                    end
                ...
                aS:Connect(
                    function()
                        E(
                            ...
                            "In",
                            {
                                BackgroundColor3 = library["flags"][cW] and p("ToggleBackgroundColor_On") or
                                    p("ToggleBackgroundColor_Off")
                            }
                        )
                        E(
                            db,
                ...
                dk.Instance.MouseEnter:Connect(
                    function()
                        E(d2.Toggle_Outline, 0.1, "Linear", "In", {ImageColor3 = o.MainColor})
                    end
                )
                dk.Instance.MouseLeave:Connect(
                    function()
            ...
            function cN:Button(dq)
                ...
                local ds = dq["Callback"] or function()
                    end
            ...
            function cN:TextBox(dv)
                ...
                local dy = dv["Callback"] or function()
                    end
            ...
            function cN:Slider(dG)
                ...
                local dJ = dG["Callback"] or function()
                    end
                ...
                dV.MouseEnter:Connect(
                    function()
                        dX = true
                    end
                )
                dV.MouseLeave:Connect(
                    function()
                        dX = false
                    end
                )
            ...
            function cN:Dropdown(e6)
                ...
                local e8 = e6["Callback"] or function()
                    end
                ...
                ei.FocusLost:Connect(
                    function()
                        E(ei.UIStroke, 0.2, "Linear", "In", {Transparency = 0.5, Color = n})
                    end
                )
                ei:GetPropertyChangedSignal("Text"):Connect(
                    function()
                ...
                local eq = function(er)
                    ...
                    es.MouseEnter:Connect(
                        function()
                            E(es, 0.1, "Linear", "In", {TextTransparency = 0})
                        end
                    )
                    es.MouseLeave:Connect(
                        function()
