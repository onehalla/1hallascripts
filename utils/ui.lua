			...
			function _tab:NewSection(section_option)
				...
				function _sections:Toggle(toggle_options)
					...
					ThemeChanged:Connect(function()
						Tween(Toggle_Outline, 0.1, "Linear", "In", {
							BackgroundColor3 = flags[toggle_flag] and GetTheme("ToggleBackgroundColor_On") or GetTheme("ToggleBackgroundColor_Off"),
						})

						Tween(CheckMark, 0.1, "Linear", "In", {

							BackgroundColor3 = flags[toggle_flag] and CurrentTheme.ToggleDotColor_On or CurrentTheme.ToggleDotColor_Off,
						})
					end)
